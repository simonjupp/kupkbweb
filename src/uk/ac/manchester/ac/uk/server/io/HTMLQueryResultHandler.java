package uk.ac.manchester.ac.uk.server.io;
...
public class HTMLQueryResultHandler implements TupleQueryResultHandler {
    ...
    public void startQueryResult(List<String> list) throws TupleQueryResultHandlerException {
        pw.println("<table class=\"sparqlResultsTable\">");
        pw.println("<tr class=\"sparqlResultsTable\">");
        for (String str : list) {
            pw.print("<th class=\"sparqlResultsTable\">");
            pw.println(str);
            pw.print("</th>");
        }
        pw.println("</tr>");
    ...
    public void handleSolution(BindingSet bindingSet) throws TupleQueryResultHandlerException {
        ...
        for (String name : bindingSet.getBindingNames()) {
            pw.print("<td class=\"sparqlResultsTable\">");
            ...
            if (bindingSet.getValue(name) != null) {
                ...
                if (value.endsWith(".gif")) {
                    ...
                    pw.print("<a href=\"" + tmp + "\" target=\"_blank\"><img width=\"300\" height=\"240\" src=\"" + tmp + "\"/></a>");
                }
                else if (value.startsWith("http")) {
                    URIImpl uri = new URIImpl(value);

                    pw.print("<a href=\"" + value + "\" target=\"_blank\">" + prefixes.get(uri.getNamespace()) + ":" + uri.getLocalName() + "</a>");
                }
                else {
                    pw.print(value);
                }
